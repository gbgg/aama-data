...
In the current revised data-set, note:
	...
	6. Every Term is associated with either a Lexeme for a Muterm. In exceptional cases a term involved in a "paradigm" which is not a term-cluster but rather a cross-classification table is associated instead with a "classLabel".
