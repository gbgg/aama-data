...
do
    ...
    Lang="${lang[@]^}"
	##pnamefile="sparql/pdgms/output/pname-$pos-list-$lang.txt";
	##add fv/nfv
	pnamefile="sparql/pdgms/output/pname-fv-list-$lang.txt";
	...
	echo 
	#title=" "
	perl pl/qstring-fv-pname2query.pl $pnamefile $pnumber $localqry $abbrev 
