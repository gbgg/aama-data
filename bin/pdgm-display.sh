...
# represented in a finite verb paradigm. A first list of these properties is contained in pdgm-finite-props.txt (generated by 
# the finite-prop-list-gen.sh) which is used by qstring2query.pl to produce a sparql query 
