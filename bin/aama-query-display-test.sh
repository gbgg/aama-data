...
# Script to test  aama-data/bin/ command-line 
# query and display scripts with different languages.
# Script calqued on aama-query-display-demo.sh
...
# usage: bin/aama-query-display-test.sh data/LANG
...
echo " to test different languages with  different kinds of "
echo " query strings, their transformation into  "
